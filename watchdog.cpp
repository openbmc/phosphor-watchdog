...
constexpr uint64_t secToUsecRatio = 1000000;
constexpr uint64_t msecToUsecRatio = 1000;
constexpr uint64_t usecToNsecRatio = 1000;

/* return current time in usec, of clock @clockId */
uint64_t Watchdog::now(clockid_t clockId) const
{
    struct timespec ts {};
